      ...
      <div className="mx-auto max-w-6xl">
        <div className="relative flex h-14 items-center rounded-2xl bg-white px-5 shadow-lg shadow-black/8">
          ...
          <div className="flex flex-1 items-center gap-2">
            ...
            <span className="text-[22px] text-[#0B1933]" style={{ fontFamily: "'OddliniUX', sans-serif", fontWeight: 500, letterSpacing: "0.1em" }}>
              InspectProof
            </span>
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 mb-12">
          ...
          <div className="max-w-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-base text-white" style={{ fontFamily: "'OddliniUX', sans-serif", fontWeight: 500, letterSpacing: "0.1em" }}>
                InspectProof
              </span>
            </div>
