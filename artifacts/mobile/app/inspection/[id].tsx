...
const styles = StyleSheet.create({
  ...
  resultCount: { fontSize: 20, fontFamily: "Inter_700Bold" },
  resultLabel: { fontSize: 11, fontFamily: "Inter_400Regular", color: Colors.textSecondary },
  overallBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  overallText: { fontSize: 15, fontFamily: "Inter_700Bold" },
  notesCard: {
    backgroundColor: Colors.surface,
    borderRadius: 12,
    borderWidth: 1,
  ...
  notesText: { fontSize: 14, fontFamily: "Inter_400Regular", color: Colors.textSecondary, lineHeight: 20 },
  ...
  checklistItemText: { fontSize: 14, fontFamily: "Inter_500Medium", color: Colors.text, lineHeight: 20 },
  nccRef: { fontSize: 11, fontFamily: "Inter_500Medium", color: Colors.secondary },
  checklistComment: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.textSecondary, lineHeight: 16 },
});
